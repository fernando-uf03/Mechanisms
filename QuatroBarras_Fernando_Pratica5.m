...
%atan2() é uma função do matlab que calcula o arctan do vetor com relação à
%horizontal
theta0=atan2(W_1y,W_1x); %theta0: ângulo do elo 2 com horizontal
theta1=atan2(Gy,Gx);     %theta1: ângulo do elo 1 com horizontal
theta3=atan2(Vy,Vx);     %theta3: ângulo do elo 3 com horizontal
...
display('Posição dos pivos fixos')
%pivo fixo O1
